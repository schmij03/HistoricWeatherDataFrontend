...
$(document).on("click","#getDataStations",function(){
  ...
  var dt = new Date(dateTill);
  console.log("naa?");
  $.get('./backend/getStationsData?ort='+stationInput+'&dateFrom='+df+'&dateTill='+dt, function(data){
    buildStationsTable(data);
    buildGraph(data);
  });
});
...
function buildRegionsTable(data){
  var table = "";
    for(var i = 0; i < data.length; i++){
      ...
      table += "<td>"+data[i]['average_temperature']+"</td>";
      table += "<td>"+data[i]['Taupunkt']+"</td>";
      table += "<td>"+data[i]['Wetterbedingung']+"</td>";
      table += "<td>"+data[i]['Windrichtung']+"</td>";
      table += "<td>"+data[i]['Luftfeuchtigkeit']+"</td>";
      table += "<td>"+data[i]['Niederschlagsmenge (letzte Stunde)']+"</td>";
      table += "<td>"+data[i]['Schneefallmenge (letzte Stunde)']+"</td>";
      table += "<td>"+data[i]['Windgeschwindigkeit']+"</td>";
...
function buildStationsTable(data){
  var table = "";
    for(var i = 0; i < data.length; i++){
      table += "<tr>";
      table += "<td>"+data[i]['Zeit']+"</td>";
      table += "<td>"+data[i]['Temperatur']+"</td>";
      table += "<td>"+data[i]['Taupunkt']+"</td>";
      table += "<td>"+data[i]['Wetterbedingung']+"</td>";
      table += "<td>"+data[i]['Windrichtung']+"</td>";
      table += "<td>"+data[i]['Luftfeuchtigkeit']+"</td>";
